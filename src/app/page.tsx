...
export default function Home() {
  ...
  useEffect(() => {
    ...
    if (hash && ['home', 'about', 'experience', 'projects', 'contact'].includes(hash)) {
      ...
      setAnimatedSections(new Set([hash]));
    }
  ...
  return (
    <main className="relative">
      ...
      <div className="md:pt-16">
        {activeSection === 'home' && (
          <div className="h-screen overflow-x-hidden overflow-y-auto pb-[100px] md:pb-[0px] ">
        ...
        {activeSection === 'contact' && (
          <div className="min-h-screen overflow-x-hidden overflow-y-auto pb-[100px] md:pb-[0px] ">
